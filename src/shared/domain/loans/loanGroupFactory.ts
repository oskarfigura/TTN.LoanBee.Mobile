...
import { generateDefaultDealName } from '@/shared/domain/mortgage/tracker';
import { LOAN_GROUP_SCHEMA_VERSION, LoanDeal, LoanFormSnapshot, LoanGroup, LoanResultSnapshot } from '@/shared/domain/types/SavedLoan';
import { DEFAULT_LOAN_PURPOSE } from '@/shared/domain/loans/loanPurpose';
import { getEffectiveLoanAmount as computeEffectiveLoanAmount } from '@/shared/lib/utils/paymentValidation';
